...
- [ ] 2.2 Create messages/pt.json part 1: nav, footer, breadcrumb, common, home page
...
- [ ] 3.1 Create lib/i18n/tools-pt.ts (30 tools: name, shortDescription, metaTitle, metaDesc + 3 categoryMeta entries)
- [ ] 3.2 Create lib/i18n/posts-pt.ts (19 post titles + descriptions)
- [ ] 3.3 Update lib/tools.ts and lib/posts.ts for locale-awareness
- [ ] 3.4 Create app/[locale]/blog/[slug]/content.pt.tsx — blog posts 1–5
...
- [ ] 4.5 Update generateStaticParams in every page file to include pt
