...
const faqs = [
  ...
  },
  {
    ...
    a: 'For 1080p at 240Hz: DisplayPort 1.2 or HDMI 2.0. For 1440p at 240Hz: DisplayPort 1.4 or DisplayPort 2.0. For 4K at 240Hz: DisplayPort 2.0 or HDMI 2.1. Not all monitors advertised as 240Hz support that rate at all resolutions — check your monitor&apos;s spec sheet for the maximum refresh rate at each supported resolution. Use DisplayPort where possible as it generally has higher bandwidth headroom than HDMI at equivalent versions.',
  },
  {
