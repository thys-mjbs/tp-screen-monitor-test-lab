...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${appUrl}/stuck-pixel-fixer/for-laptops`, priority: 0.8, changeFrequency: 'monthly' as const },
    { url: `${appUrl}/image-retention-test/for-laptops`, priority: 0.8, changeFrequency: 'monthly' as const },
    { url: `${appUrl}/screen-uniformity-test/for-ultrawide`, priority: 0.8, changeFrequency: 'monthly' as const },
    { url: `${appUrl}/dead-pixel-test/for-gaming-monitors`, priority: 0.8, changeFrequency: 'monthly' as const },
    { url: `${appUrl}/backlight-bleed-test/for-curved-monitors`, priority: 0.8, changeFrequency: 'monthly' as const },
    { url: `${appUrl}/gamma-calibration-check/for-photography`, priority: 0.8, changeFrequency: 'monthly' as const },
    { url: `${appUrl}/refresh-rate-checker/240hz-test`, priority: 0.8, changeFrequency: 'monthly' as const },
    { url: `${appUrl}/contrast-black-level-test/for-oled`, priority: 0.8, changeFrequency: 'monthly' as const },
    { url: `${appUrl}/viewing-angle-test/for-laptops`, priority: 0.8, changeFrequency: 'monthly' as const },
    { url: `${appUrl}/resolution-checker/for-ultrawide`, priority: 0.8, changeFrequency: 'monthly' as const },
